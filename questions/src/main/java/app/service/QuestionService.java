...
import app.repository.QuestionEventRepository;
...
public class QuestionService {
    ...
    private QuestionEventRepository eventRepository;


    @Autowired
    public QuestionService(QuestionRepository questionRepository, QuestionEventRepository eventRepository)
    {
